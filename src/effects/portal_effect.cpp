...
namespace space
{
    PortalEffect::PortalEffect(const ObjectId &id, size_t numParticles) : SpaceObject(id, SpaceObjectType2::Unknown), _vertices(sf::Points, numParticles), _shader(nullptr)
    {
