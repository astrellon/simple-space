...
namespace ImGui
{
    namespace SFML
    {
        ...
        IMGUI_SFML_API void Update(float cameraScale, sf::RenderWindow& window, sf::Time dt);
        IMGUI_SFML_API void Update(float cameraScale, sf::Window& window, sf::RenderTarget& target, sf::Time dt);
        IMGUI_SFML_API void Update(float cameraScale, sf::Vector2i mousePos, const sf::Vector2f& displaySize, sf::Time dt);
